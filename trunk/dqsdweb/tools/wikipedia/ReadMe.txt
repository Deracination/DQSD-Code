...
- Edit the .reg file and correct the path to the extracted .html file (or just go ahead and merge to the registry and make the changes thru regedit).  I.e., if you extracted the files to "C:\Documents and Settings\Glenn\My Documents\search_wikipedia.html", change the path in the .reg to "C:\\Documents and Settings\\Glenn\\My Documents\\search_wikipedia.html".
