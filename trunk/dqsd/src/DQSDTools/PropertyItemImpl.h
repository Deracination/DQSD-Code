...
public:
   ...
   {
      ATLASSERT(!::IsBadStringPtr(pstrName,static_cast<UINT_PTR>(-1)));
...
public:
   ...
   {
      ATLASSERT(!::IsBadStringPtr(pstrText,static_cast<UINT_PTR>(-1)));
...
{
   ATLASSERT(!::IsBadStringPtr(pstrFileName,static_cast<UINT_PTR>(-1)));
...
{
   ATLASSERT(!::IsBadStringPtr(pstrValue,static_cast<UINT_PTR>(-1)));
